...
// Handle POST request
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['name'], $_POST['email'], $_POST['department'])) {
    $name = $_POST['name'];
    $email = $_POST['email'];
    ...
    if ($conn->query($sql) === TRUE) {
        $response = ['success' => true, 'message' => 'Instructor added successfully'];
    } else {
        $response = ['success' => false, 'message' => 'Error adding instructor: ' . $conn->error];
    }
